...
var _src_transport_file = {};
var _src_transport_transport = {};
var _src_util_arr = {};
var _src_util_cli = {};
var _src_util_dir = {};
...
var FileWatcher = /** @class */ (function (_super) {
    ...
    ], FileWatcher.prototype, "changed");
    __decorate([
        global_1.Class.deco.self
    ], FileWatcher.prototype, "reportChange");
    return FileWatcher;
...
exports.FileTransport = {
    ...
    copyAsync: function (from, to, cb) {
        exports.FileTransport.existsAsync(from, prepairFn);
    ...
    remove: function (path) {
        if (exports.FileTransport.exists(path) === false)
            return true;
        try {
...
;
	...
	if (isObject(_src_transport_file) && isObject(module.exports)) {
		Object.assign(_src_transport_file, module.exports);
		return;
	}
	_src_transport_file = module.exports;
}());
// end:source ./ModuleSimplified.js
...
var file_1 = _src_transport_file;
var path_1 = _src_util_path;
function transport_save(path, content, options) {
    var transport = getTransportForPath(path);
    transport.save(path, content, options);
}
exports.transport_save = transport_save;
;
function transport_saveAsync(path, content, options, cb) {
    var transport = getTransportForPath(path);
    transport.saveAsync(path, content, options, cb);
}
exports.transport_saveAsync = transport_saveAsync;
;
function transport_copy(from, to) {
    var fromTransport = getTransportForPath(from);
    var toTransport = getTransportForPath(to);
...
exports.transport_copy = transport_copy;
;
function transport_copyAsync(from, to, cb) {
    var fromTransport = getTransportForPath(from);
    var toTransport = getTransportForPath(to);
    if (fromTransport === toTransport) {
...
exports.transport_copyAsync = transport_copyAsync;
;
function transport_exists(path) {
    var transport = getTransportForPath(path);
    return transport.exists(path);
}
exports.transport_exists = transport_exists;
;
function transport_existsAsync(path, cb) {
    var transport = getTransportForPath(path);
    return transport.existsAsync(path, cb);
}
exports.transport_existsAsync = transport_existsAsync;
;
function transport_read(path, encoding) {
    var transport = getTransportForPath(path);
    return transport.read(path, encoding);
}
exports.transport_read = transport_read;
;
function transport_readAsync(path, encoding, cb) {
    var transport = getTransportForPath(path);
    transport.readAsync(path, encoding, cb);
}
exports.transport_readAsync = transport_readAsync;
;
function transport_remove(path) {
    var transport = getTransportForPath(path);
    return transport.remove(path);
}
exports.transport_remove = transport_remove;
;
function transport_removeAsync(path, cb) {
    var transport = getTransportForPath(path);
    transport.removeAsync(path, cb);
}
exports.transport_removeAsync = transport_removeAsync;
;
function transport_rename(path, filename) {
    var transport = getTransportForPath(path);
    return transport.rename(path, filename);
}
exports.transport_rename = transport_rename;
;
function transport_renameAsync(path, filename, cb) {
    var transport = getTransportForPath(path);
    transport.renameAsync(path, filename, cb);
}
exports.transport_renameAsync = transport_renameAsync;
;
function getTransportForPath(path) {
    var protocol = path_1.path_getProtocol(path);
    if (protocol == null || protocol === 'file') {
        return file_1.FileTransport;
    }
...
;
	...
	if (isObject(_src_transport_transport) && isObject(module.exports)) {
		Object.assign(_src_transport_transport, module.exports);
		return;
	}
	_src_transport_transport = module.exports;
}());
// end:source ./ModuleSimplified.js
...
var atma_utils_1 = require("atma-utils");
var path_1 = _src_util_path;
var transport_1 = _src_transport_transport;
var global_1 = _src_global;
var logger_1 = _src_util_logger;
var filesystem_util_1 = _src_util_filesystem_util;
var Env_1 = _src_Env;
...
var File = /** @class */ (function () {
    ...
    File.prototype.read = function (mix) {
        ...
        this.content = transport_1.transport_read(path, setts.encoding);
    ...
    File.prototype.readAsync = function (mix) {
        return dfr_factory(this, function (dfr, file, path) {
            ...
            transport_1.transport_readAsync(path, setts.encoding, onReadComplete);
    ...
    File.prototype.write = function (content, mix) {
        ...
        transport_1.transport_save(path, this.content, setts);
        return this;
    };
    ...
    File.prototype.writeAsync = function (content, mix) {
        return dfr_factory(this, function (dfr, file, path) {
            ...
            function onHookComplete() {
                transport_1.transport_saveAsync(path, file.content, setts, dfr_pipeDelegate(dfr));
            }
        });
    };
    ...
    File.prototype.copyTo = function (target) {
        var from = uri_toPath(this.uri), uri = path_1.path_getUri(target), to = uri.file
            ? uri_toPath(uri)
        ...
        transport_1.transport_copy(from, to);
        return this;
    };
    ...
    File.prototype.copyToAsync = function (target) {
        return dfr_factory(this, function (dfr, file, path) {
            transport_1.transport_copyAsync(path, uri_toPath(path_1.path_getUri(target)), dfr_pipeDelegate(dfr));
        });
    };
    ...
    File.prototype.exists = function () {
        return transport_1.transport_exists(uri_toPath(this.uri));
    };
    ...
    File.prototype.existsAsync = function () {
        return dfr_factory(this, function (dfr, file, path) {
            transport_1.transport_existsAsync(path, dfr_pipeDelegate(dfr));
        });
    };
    ...
    File.prototype.rename = function (fileName) {
        return transport_1.transport_rename(uri_toPath(this.uri), fileName);
    };
    ...
    File.prototype.renameAsync = function (filename) {
        return dfr_factory(this, function (dfr, file, path) {
            transport_1.transport_renameAsync(path, filename, dfr_pipeDelegate(dfr));
        });
    };
    ...
    File.prototype.remove = function () {
        return transport_1.transport_remove(uri_toPath(this.uri));
    };
    ...
    File.prototype.removeAsync = function () {
        return dfr_factory(this, function (dfr, file, path) {
            transport_1.transport_removeAsync(path, dfr_pipeDelegate(dfr));
        });
    };
...
var Factory = /** @class */ (function () {
    ...
    __decorate([
        global_1.Class.deco.self
    ], Factory.prototype, "process");
    __decorate([
        global_1.Class.deco.self
    ], Factory.prototype, "next");
    return Factory;
}());
...
var Directory = /** @class */ (function () {
    ...
    Directory.prototype.readFiles = function (pattern, exclude) {
        ...
        var arr = this.files = dir_1.dir_files(this.uri.toLocalDir(), patterns, excludes)
            .map(function (path) {
...
var global_1 = _src_global;
if (global_1.global.io && global_1.global.io.File && typeof global_1.global.io.File.getFactory === 'function') {
    var globalFile = global_1.global.io.File;
    File_1.File.registerFactory(globalFile.getFactory());
    File_1.File.registerHookHandler(globalFile.getHookHandler());
    File_1.File.middleware = globalFile.middleware;
}
else {
    ...
    File_1.File.registerExtensions({
        'json': [
            [json_1.JsonMiddleware, 'read'],
            [json_1.JsonMiddleware, 'write'],
        ]
    });
}
;
