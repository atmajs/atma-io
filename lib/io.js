...
var File = /** @class */ (function () {
    ...
    File.prototype.writeAsync = function (content, mix) {
        return dfr_factory(this, function (dfr, file, path) {
            ...
            function onHookComplete() {
                file_transport_1.file_saveAsync(path, file.content, setts, dfr_pipeDelegate(dfr));
            }
        });
    };
    ...
    File.prototype.copyTo = function (target) {
        ...
        file_transport_1.file_copy(from, to);
        return this;
    };
    ...
    File.prototype.copyToAsync = function (target) {
        return dfr_factory(this, function (dfr, file, path) {
            file_transport_1.file_copyAsync(path, uri_toPath(path_1.path_getUri(target)), dfr_pipeDelegate(dfr));
        });
    };
...
var Directory = /** @class */ (function () {
    ...
    Directory.prototype.exists = function () {
        return dir_transport_1.dir_exists(this.uri.toLocalDir());
    };
    ...
    Directory.prototype.ensure = function () {
        dir_transport_1.dir_ensure(this.uri.toLocalDir());
        return this;
    };
    ...
    Directory.prototype.readFiles = function (pattern, exclude) {
        ...
        var arr = this.files = dir_transport_1.dir_files(this.uri.toLocalDir(), patterns, excludes)
            .map(function (path) {
    ...
    Directory.prototype.read = function (pattern, exclude) {
        var _this = this;
        var patterns = glob_1.glob_parsePatterns(pattern), excludes = glob_1.glob_parsePatterns(exclude);
        return dir_transport_1.dir_files(this.uri.toLocalDir(), patterns, excludes, { directories: true })
            .map(function (x) {
    ...
    Directory.prototype.remove = function () {
        dir_transport_1.dir_remove(this.uri.toLocalDir());
    };
