...
var FileHooks = /** @class */ (function () {
    ...
    FileHooks.prototype.contains = function (method, handler, regexp) {
        var _a, _b;
        var str = (_a = regexp) === null || _a === void 0 ? void 0 : _a.toString();
        ...
        while (++i < imax) {
            ...
            if (str != null && str !== ((_b = hook.regexp) === null || _b === void 0 ? void 0 : _b.toString())) {
                continue;
            }
...
var FileSafe = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (this.busy) {
                            return [2 /*return*/, (_a = this.pending, (_a !== null && _a !== void 0 ? _a : this.content))];
                        }
    ...
    FileSafe.prototype.readInner = function () {
        return __awaiter(this, void 0, Promise, function () {
            var existsBak, str, exists, content;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 5:
                        error_2 = _d.sent();
                        this.errored = error_2;
                        this.callWriteListeners(v, error_2);
                        return [3 /*break*/, 7];
                    case 6:
...
var LockFile = /** @class */ (function () {
    ...
    LockFile.prototype.pollAcquire = function () {
        ...
        this.pollTimeout = setTimeout(function () {
            _this.tryAcquire(function (err, cb) {
                if (err) {
                    _this.onError(err);
                    return;
                }
...
;
	...
	if (isObject(_src_FileSafe) && isObject(module.exports)) {
