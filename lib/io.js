(function(root, factory){
	...
	(function(){
		...
		// end:source middleware/traceur.js
		// source middleware/less.js
		(function() {
		...
		(function() {
			...
			io.File.middleware['condcomments'] = function(file, defines) {
