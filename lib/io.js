...
var mainFile = new atma_utils_1.class_Uri(normalizePath(mainModule.filename));
var mainDir = new atma_utils_1.class_Uri(normalizePath(mainModule.path));
...
;
    ...
    if (__isObj(_src_transport_filesystem_FsTransport) && __isObj(module.exports)) {
...
function cb_toPromiseCtx(ctx, fn) {
    ...
    return new Promise(function (resolve, reject) {
        fn.call.apply(fn, __spreadArrays([ctx], args, [function (error, result) {
                if (error) {
                    reject(error);
                    return;
                }
...
;
    ...
    if (__isObj(_src_util_cb) && __isObj(module.exports)) {
...
;
    ...
    if (__isObj(_src_transport_filesystem_safe_LockFile) && __isObj(module.exports)) {
...
var SafeFile = /** @class */ (function () {
    ...
    function SafeFile(path, opts) {
        ...
        this.lockOutProc = ((_a = this.opts) === null || _a === void 0 ? void 0 : _a.threadSafe) ? new LockFile_1.LockFile(this.path)
            : null;
    ...
    SafeFile.prototype.readInner = function (encoding) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cb_1.cb_toPromise(fs_file_1.FileFsTransport.existsAsync, this.pathBak)];
                    case 1:
                        existsBak = _a.sent();
                        if (!existsBak) return [3 /*break*/, 6];
                        return [4 /*yield*/, cb_1.cb_toPromise(fs_file_1.FileFsTransport.readAsync, this.pathBak, encoding)];
                    case 2:
                        str = _a.sent();
                        if (!str) return [3 /*break*/, 4];
                        return [4 /*yield*/, cb_1.cb_toPromise(fs_file_1.FileFsTransport.renameAsync, this.pathBak, this.pathFilename)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, str];
                    case 4: return [4 /*yield*/, cb_1.cb_toPromise(fs_file_1.FileFsTransport.removeAsync, this.pathBak)];
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6:
                        _a.trys.push([6, 8, , 9]);
                        return [4 /*yield*/, cb_1.cb_toPromise(fs_file_1.FileFsTransport.readAsync, this.path, encoding)];
                    case 7:
                        content = _a.sent();
                        return [2 /*return*/, content];
                    case 8:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        _d.sent();
                        return [4 /*yield*/, cb_1.cb_toPromise(fs_file_1.FileFsTransport.saveAsync, this.pathBak, data, null)];
                    case 3:
                        _d.sent();
                        return [4 /*yield*/, cb_1.cb_toPromise(fs_file_1.FileFsTransport.renameAsync, this.pathBak, this.pathFilename)];
                    case 4:
...
;
    ...
    if (__isObj(_src_transport_filesystem_safe_SafeFile) && __isObj(module.exports)) {
...
;
    ...
    if (__isObj(_src_transport_filesystem_FsTransportSafe) && __isObj(module.exports)) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!is_1.is_Promise(result)) return [3 /*break*/, 2];
...
function _saveAsync(path, content, options) {
    ...
    return cb_1.cb_toPromise(transport.saveAsync, path, content, options);
}
...
function file_existsAsync(path) {
    ...
    return cb_1.cb_toPromise(transport.existsAsync, path);
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    content = _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, cb_1.cb_toPromise(transport.readAsync, path, preprocessAsync == null ? encoding : null)];
                case 3:
                    content = _a.sent();
                    _a.label = 4;
                case 4:
...
var File = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        _a = this;
                        return [4 /*yield*/, file_transport_1.file_readAsync(path, setts.encoding, options, preprocess)];
                    case 2:
                        _a.content = _b.sent();
    ...
    File.prototype.write = function (content, mix) {
        ...
        file_transport_1.file_save(path, this.content, setts, getTransportWriterMiddleware(mix, this.opts));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.content = null;
                        return [4 /*yield*/, file_transport_1.file_saveAsync(path, body, opts, getTransportWriterMiddleware(mix, opts))];
                    case 2:
                        _a.sent();
    ...
    File.prototype.exists = function () {
        var path = uri_toPath(this.uri);
        return file_transport_1.file_exists(path);
    };
    ...
    File.prototype.existsAsync = function () {
        var path = uri_toPath(this.uri);
        return file_transport_1.file_existsAsync(path);
    };
...
function processHooksAsync(method, file, setts, config) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, cb_1.cb_toPromiseCtx(hooks, hooks.triggerAsync, method, file, config)];
        });
    });
}
