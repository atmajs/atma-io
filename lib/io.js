...
var _node_modules_atma_utils_src_class_EventEmitter = {};
var _node_modules_atma_utils_src_class_Uri = {};
var _node_modules_atma_utils_src_fn = {};
var _node_modules_atma_utils_src_is = {};
var _node_modules_atma_utils_src_refs = {};
var _src_Directory = {};
var _src_Env = {};
var _src_EnvNode = {};
...
;
    ...
    if (_node_modules_atma_utils_src_class_Uri === module.exports) {
        // do nothing if
    } else if (__isObj(_node_modules_atma_utils_src_class_Uri) && __isObj(module.exports)) {
        Object.assign(_node_modules_atma_utils_src_class_Uri, module.exports);
    } else {
        _node_modules_atma_utils_src_class_Uri = module.exports;
    }
...
;
    ...
    if (_node_modules_atma_utils_src_fn === module.exports) {
        // do nothing if
    } else if (__isObj(_node_modules_atma_utils_src_fn) && __isObj(module.exports)) {
        Object.assign(_node_modules_atma_utils_src_fn, module.exports);
    } else {
        _node_modules_atma_utils_src_fn = module.exports;
    }
...
;
    ...
    if (_node_modules_atma_utils_src_is === module.exports) {
        // do nothing if
    } else if (__isObj(_node_modules_atma_utils_src_is) && __isObj(module.exports)) {
        Object.assign(_node_modules_atma_utils_src_is, module.exports);
    } else {
        _node_modules_atma_utils_src_is = module.exports;
    }
...
;
    ...
    if (_node_modules_atma_utils_src_refs === module.exports) {
        // do nothing if
    } else if (__isObj(_node_modules_atma_utils_src_refs) && __isObj(module.exports)) {
        Object.assign(_node_modules_atma_utils_src_refs, module.exports);
    } else {
        _node_modules_atma_utils_src_refs = module.exports;
    }
...
var fn_1 = _node_modules_atma_utils_src_fn;
var is_1 = _node_modules_atma_utils_src_is;
var refs_1 = _node_modules_atma_utils_src_refs;
...
;
    ...
    if (_node_modules_atma_utils_src_class_Dfr === module.exports) {
        // do nothing if
    } else if (__isObj(_node_modules_atma_utils_src_class_Dfr) && __isObj(module.exports)) {
        Object.assign(_node_modules_atma_utils_src_class_Dfr, module.exports);
    } else {
        _node_modules_atma_utils_src_class_Dfr = module.exports;
    }
...
;
    ...
    if (_node_modules_atma_utils_src_class_EventEmitter === module.exports) {
        // do nothing if
    } else if (__isObj(_node_modules_atma_utils_src_class_EventEmitter) && __isObj(module.exports)) {
        Object.assign(_node_modules_atma_utils_src_class_EventEmitter, module.exports);
    } else {
        _node_modules_atma_utils_src_class_EventEmitter = module.exports;
    }
...
function getSysDir(path) {
    ...
    return new global_1.class_Uri(path);
}
...
function path_getUri(path, base) {
    ...
    var uri = new global_1.class_Uri(path);
    if (uri.isRelative() === false) {
        return uri;
    }
    if (base) {
        return new global_1.class_Uri(base).combine(uri);
    }
    if (global_1.io.env) {
        return global_1.io.env.currentDir.combine(uri);
    }
    if (constants_1.is_BROWSER_BUILD) {
        return new global_1.class_Uri(location.origin).combine(uri);
    }
    return new global_1.class_Uri('file://' + process.cwd() + '/')
        .combine(uri);
}
...
function path_resolveUri(url, parentLocation, base) {
    ...
    return uri.isRelative()
        ? (new global_1.class_Uri(parentLocation)).combine(uri)
        : uri;
}
...
var LockFile = /** @class */ (function () {
    ...
    LockFile.prototype.onRelease = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.releasingDfr = new global_1.class_Dfr();
    ...
    LockFile.prototype.upgradeLock = function () {
        var _this = this;
        this.upgradingDfr = new global_1.class_Dfr;
...
var SafeFile = /** @class */ (function () {
    ...
    function SafeFile(path, opts) {
        ...
        this.lockInProc = new global_1.class_Dfr;
...
(function (mimeTypes) {
    function fromPath(url) {
        ...
        var rgxExt = /\.(?<ext>[\w]{1,})($|\?)/;
        var ext = (_d = (_c = (_b = (_a = rgxExt.exec(url)) === null || _a === void 0 ? void 0 : _a.groups) === null || _b === void 0 ? void 0 : _b.ext) === null || _c === void 0 ? void 0 : _c.toLowerCase()) !== null && _d !== void 0 ? _d : 'buffer';
    ...
    File.clearCache = function (mix) {
        ...
        if (typeof mix === 'string') {
            ...
            if (_cache.hasOwnProperty(path) === false && mix.charCodeAt(0) === 47) {
                path = global_1.class_Uri.combine(Env_1.Env.cwd, mix);
            }
        }
        else if (mix.uri) {
...
if (global_3.global.io && global_3.global.io.File && typeof global_3.global.io.File.getFactory === 'function') {
    var globalFile = global_3.global.io.File;
...
var AwaitCallbacks = /** @class */ (function () {
    function AwaitCallbacks() {
        this.promise = new global_1.class_Dfr;
        this.error = null;
        ...
        return dfr_factory(this, function (dfr, dir, path) {
            (0, dir_transport_1.dir_filesAsync)(path, patterns, exclude, function (error, files) {
                ...
                dir.files = files.map(function (x) {
                    var uri = new global_1.class_Uri(x);
                    if (uri.isRelative()) {
...
function uri_toDirectory(uri) {
    ...
    var path = fs
        ...
        : null;
    if (fs === false) {
        uri = new global_1.class_Uri(uri);
        uri.file = null;
        path = uri.toString();
    }
    return path;
...
//#endif
global_1.io.Uri = global_1.class_Uri;
