!function(factory) {
    ...
    !function() {
        ...
        var exports = null != _src_global ? _src_global : {}, module = {
            exports: exports
        }, atma_utils_1 = (Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.io = exports.logger = exports.global = exports.class_EventEmitter = exports.class_Dfr = exports.class_Uri = void 0, 
        _node_modules_atma_utils_lib_utils), $global = (Object.defineProperty(exports, "class_Uri", {
            enumerable: !0,
            get: function() {
                return atma_utils_1.class_Uri;
            }
        }), Object.defineProperty(exports, "class_Dfr", {
            enumerable: !0,
            get: function() {
                return atma_utils_1.class_Dfr;
            }
        }), Object.defineProperty(exports, "class_EventEmitter", {
            enumerable: !0,
            get: function() {
                return atma_utils_1.class_EventEmitter;
            }
        }), void 0 === global ? window : global), $global = (exports.global = $global).logger;
        ...
        const cwd = new _src_global.class_Uri(location.origin + "/");
        function __isObj(x) {
            return null != x && "object" == typeof x && x.constructor === Object;
        }
        exports.EnvBrowser = {
        ...
        const constants_1 = _src_constants, global_1 = _src_global;
        ...
        exports.path_getProtocol = function(path) {
            ...
            !1 === (path = new global_1.class_Uri(path)).isRelative() ? path : (base ? new global_1.class_Uri(base) : global_1.io.env ? global_1.io.env.currentDir : constants_1.is_BROWSER_BUILD ? new global_1.class_Uri(location.origin) : new global_1.class_Uri("file://" + process.cwd() + "/")).combine(path);
            ...
            (base = new global_1.class_Uri(url)).isRelative() ? new global_1.class_Uri(parentLocation).combine(base) : base;
...
`;
        ...
        const global_1 = _src_global, path_1 = _src_util_path, file_transport_1 = _src_transport_file_transport, global_2 = _src_global, logger_1 = _src_util_logger, Env_1 = _src_Env;
        ...
        var json_1 = _src_middleware_json, global_3 = _src_global;
        const uri_1 = _src_util_uri, cb_1 = _src_util_cb, constants_1 = _src_constants;
        ...
        class File {
            ...
            write(content, mix) {
                var setts;
                return null != content && (this.content = content), null == this.content ? global_2.logger.error("io.file.write: Content is empty") : (content = uri_toPath(this.uri), 
            ...
            static clearCache(mix) {
                if (!1 !== _cacheEnabled) if (0 === arguments.length) _cache = {}; else if (null != mix) {
                    ...
                    path = uri_toPath((0, path_1.path_getUri)(mix)), !1 === _cache.hasOwnProperty(path) && 47 === mix.charCodeAt(0) && (path = global_1.class_Uri.combine(Env_1.Env.cwd, mix))) : mix.uri ? path = uri_toPath(mix.uri) : mix.toLocalFile && (path = uri_toPath(mix)), 
                    !1 === _cache.hasOwnProperty(path) ? global_2.logger.log("io.File - not in cache -", path) : delete _cache[path];
                }
            }
            static disableCache() {
        ...
        (exports.File = File).middleware = {}, global_3.global.io && global_3.global.io.File && "function" == typeof global_3.global.io.File.getFactory ? (exports = global_3.global.io.File, 
        File.registerFactory(exports.getFactory()), File.registerHookHandler(exports.getHookHandler()), 
        File.middleware = exports.middleware, exports.getTransports && File.setTransports(exports.getTransports())) : (global_3 = new FileFactory_1.FileFactory(), 
        exports = new FileHooks_1.FileHooks(), File.registerFactory(global_3), File.registerHookHandler(exports), 
    ...
    global_1.io.File = File_1.File, global_1.io.env = Env_1.Env, global_1.io.Uri = global_1.class_Uri, 
