...
(function (Errno) {
    ...
    Errno.isPermission = isPermission;
...
exports.FileFsTransport = {
    ...
    renameAsync(path, filename, cb) {
        ...
        __fs.rename(path, targetPath, function (error) {
...
class LockFile {
    ...
    tryAcquire(cb) {
        fs.open(this.pathLock, 'wx', (err, fd) => {
            ...
            if (Errno_1.Errno.isExists(err) || Errno_1.Errno.isPermission(err)) {
                cb(null, false);
                return;
            }
            cb(err);
    ...
    doCheckStale() {
        fs.stat(this.pathLock, (err, stats) => {
            if (err) {
                ...
                if (Errno_1.Errno.isPermission(err)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_util__promise != null ? _src_util__promise : {};
    var module = { exports: exports };
...
(function ($promise) {
    ...
    function waitForTrue(check, opts) {
        return waitForObject(() => __awaiter(this, void 0, void 0, function* () {
            let result = yield check();
    ...
    function waitForObject(check, opts) {
        ...
        let start = Date.now();
        let completed = false;
        let intervalMs = (_a = opts === null || opts === void 0 ? void 0 : opts.intervalMs) !== null && _a !== void 0 ? _a : 500;
        let timeoutMs = (_b = opts === null || opts === void 0 ? void 0 : opts.timeoutMs) !== null && _b !== void 0 ? _b : null;
        let timeoutMessage = (_c = opts === null || opts === void 0 ? void 0 : opts.timeoutMessage) !== null && _c !== void 0 ? _c : `Waiting for object timeouted`;
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            function tick() {
                var _a;
                return __awaiter(this, void 0, void 0, function* () {
                    let [error, result] = (_a = (yield callMethodAndCatchErrors(check))) !== null && _a !== void 0 ? _a : [null, null];
                    if (result != null) {
                        completed = true;
                        resolve(result);
                        return;
            ...
            while (true) {
                ...
                yield $promise.wait(intervalMs);
            }
        }));
    }
    $promise.waitForObject = waitForObject;
    function callMethodAndCatchErrors(fn) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield fn();
            }
...
//# sourceMappingURL=$promise.ts.map;
    ...
    if (_src_util__promise === module.exports) {
        // do nothing if
    } else if (__isObj(_src_util__promise) && __isObj(module.exports)) {
        Object.assign(_src_util__promise, module.exports);
    } else {
        _src_util__promise = module.exports;
    }
...
const _promise_1 = _src_util__promise;
/**
    ...
    writeInner(data) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (Errno_1.Errno.isPermission(error)) {
                    // Sometimes system may lock the file for short period, so retry
                    const RETRIES = 10;
                    for (let i = 0; i < RETRIES; i++) {
                        yield _promise_1.$promise.wait((i + 1) * 50);
                        let result = yield (0, cb_1.cb_toPromiseTuple)(fs_file_1.FileFsTransport.renameAsync, this.pathBak, this.pathFilename);
                        error = result.error;
                        if (Errno_1.Errno.isPermission(error)) {
                            continue;
                        }
...
(function (FsTransportSafe) {
    ...
    FsTransportSafe.File = Object.assign(Object.assign({}, FsTransport_1.FsTransport.File), { save(path, content, options) {
        ...
        saveAsync(path, content, options, cb) {
            var _a;
            let file = (_a = SAFE_FILES[path]) !== null && _a !== void 0 ? _a : (SAFE_FILES[path] = new SafeFile_1.SafeFile(path, options));
            file
                .writeAsync(content)
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.settings = exports.Uri = exports.env = exports.File = exports.Directory = exports.LockFile = exports.FileSafe = exports.glob = exports.watcher = void 0;
const global_1 = _src_global;
const Env_1 = _src_Env;
const File_1 = _src_File;
...
Object.defineProperty(exports, "FileSafe", { enumerable: true, get: function () { return FileSafe_1.FileSafe; } });
const LockFile_1 = _src_transport_filesystem_safe_LockFile;
...
exports.glob = ExportsGlob_1.Glob;
//#endif
...
exports.default = global_1.io;
exports.env = Env_1.Env;
exports.Uri = atma_utils_1.class_Uri;
...
export const watcher = module.exports.watcher;
export const glob = module.exports.glob;
export const FileSafe = module.exports.FileSafe;
export const LockFile = module.exports.LockFile;
export const Directory = module.exports.Directory;
export const File = module.exports.File;
export const env = module.exports.env;
export const Uri = module.exports.Uri;
export const settings = module.exports.settings;
